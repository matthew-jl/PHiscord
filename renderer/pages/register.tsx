  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-dc-900">
      ...
      <div className="flex flex-col bg-dc-700 min-w-96 text-primary p-7 rounded-lg shadow-md">
        <h2 className="font-bold text-xl mb-1 text-center">Create an account</h2>
        <p className="text-sm mb-4 text-center">Enjoy your journey in PHiscord!</p>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSignUp)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-xs font-semibold text-primary">USERNAME</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-xs font-semibold text-primary">CONFIRM PASSWORD</FormLabel>
                  <FormControl>
                    <Input type="password" {...field} className="min-w-full bg-dc-900 p-2 rounded-md focus-visible:ring-0 focus-visible:ring-offset-0" />
                  </FormControl>
                  <FormMessage className="text-red-500" />
            ...
            <Button disabled={form.formState.isSubmitting} variant='blurple' className="font-bold min-w-full">Register</Button>
          </form>
        </Form>
