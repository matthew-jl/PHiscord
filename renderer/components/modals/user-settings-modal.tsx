    ...
    const fetchUserData = async () => {
      ...
      if (userDoc.exists()) {
        ...
        const profilePictureUrl = await getDownloadURL(
          ref(storage, userDoc.data().imageUrl)
        );
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-4">
                          ...
                          <Label
                            ...
                            className="cursor-pointer flex items-center rounded-md p-2 hover:bg-dc-700"
                          >
                            <HiPencil size={20} />
                  ...
                  <div className="space-y-2 mt-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="blurple">Edit Password</Button>
                      </PopoverTrigger>
                      <PopoverContent side="right">
                        <Form {...reauthForm}>
                          <form
                            onSubmit={reauthForm.handleSubmit(reauthOnSubmit)}
                            className="space-y-4"
                          >
                            <FormField
                        ...
                        <FormControl>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent side="right">
                              <DropdownMenuCheckboxItem
                                onClick={() =>
                                  handleDirectMessagesChange("allow")
                                }
                              ...
                              <DropdownMenuCheckboxItem
                                onClick={() =>
                                  handleDirectMessagesChange("request")
                                }
                              ...
                              <DropdownMenuCheckboxItem
                                onClick={() =>
                                  handleDirectMessagesChange("block")
                                }
