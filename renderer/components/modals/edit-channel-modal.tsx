...
import { doc, updateDoc, getDoc, setDoc, deleteField, deleteDoc } from '@firebase/firestore'
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={handleClose}>
            <DialogContent className='bg-dc-800'>
                <DialogHeader>
                    <DialogTitle className='text-center text-primary text-2xl'>Edit Channel</DialogTitle>
                    <DialogDescription className='text-center text-dc-500'>
                        <p>Change your channel name or delete it :(</p>
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-7'>
                        ...
                        <DialogFooter>
                            <Button type='button' disabled={isLoading} variant='destructive' onClick={deleteChannel}>
                                Delete Channel
                            </Button>
